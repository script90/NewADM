...
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3NjcmlwdDkwL05ld0FETS9tYXN0ZXIvcmVxdWVzdAo="
SUB_DOM='base64 -d'
...
inst_components () {
_pacotes=("bc" "man" "zip" "unzip" "nano" "screen" "lsof" "nload" "ufw" "screen" "htop" "curl" "mlocate" "nload" "python" "python3" "python-pip")
